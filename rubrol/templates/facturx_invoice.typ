// Rubrol Enterprise Template Vault: EU Factur-X / ZUGFeRD B2B Invoice
...
#let line_items = data.at("line_items", default: (
  (name: "Rubrol Enterprise Engine - Annual Cluster License", description: "Sub-8ms dynamic Typst sidecar with unlimited nodes & font cache reuse", qty: 1, unit_price: 2400.00, tax_rate: 0.20),
