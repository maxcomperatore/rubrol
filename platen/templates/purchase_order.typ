// Platen Template Vault: Enterprise Purchase Order
...
#let vendor = data.at("vendor", default: (
  company: "Platen Technologies Inc.",
  address: "548 Market Street, Suite 300",
  city: "San Francisco, CA 94104",
  contact: "enterprise@platenengine.com"
))

#let items = data.at("items", default: (
  (line: 1, item_code: "PLT-ECR-AIRGAP", description: "Platen Enterprise Air-Gapped ECR License (Perpetual)", qty: 2, unit_cost: 4800.00),
