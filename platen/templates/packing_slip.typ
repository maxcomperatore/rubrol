// Platen Template Vault: Warehouse Logistics Packing Slip
...
#let warehouse = data.at("warehouse", default: (
  name: "Platen Logistics Hub West",
...
#let packages = data.at("packages", default: (
  (sku: "PLT-SRV-1U", description: "Platen 1U Rack Engine Appliance", qty: 2, weight: "14.2 lbs"),
