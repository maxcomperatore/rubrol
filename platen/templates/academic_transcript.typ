// Platen Template Vault: Official University Academic Transcript
...
#set page(
  ...
  footer: [
    ...
    #v(1mm)
    #text(size: 7pt, fill: rgb("#94a3b8"))[Record is authentic if verified via Platen cryptographic signature chain. Alteration invalidates this document.]
  ]
)
...
#grid(
  ...
  rect(width: 100%, stroke: 0.5pt + rgb("#e2e8f0"), radius: 4pt, inset: 8pt)[
    ...
    #text(size: 7.5pt, fill: rgb("#64748b"))[
      ...
      This transcript was compiled directly by the Platen sub-8ms engine with cryptographically anchored record integrity.
    ]
  ],
  rect(width: 100%, stroke: 0.5pt + rgb("#e2e8f0"), radius: 4pt, inset: 8pt)[
